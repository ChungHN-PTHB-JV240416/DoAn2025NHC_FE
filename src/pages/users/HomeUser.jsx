...
const HomeUser = () => {
  ...
  const posts = [
    ...
    {
      id: 2,
      title: "Tối ưu hóa trải nghiệm người dùng trong phần mềm bán điện thoại",
      excerpt: "Làm thế nào để tạo ra một giao diện thân thiện và thu hút khách hàng khi mua điện thoại trực tuyến?",
        ...
        <div style={{ minHeight: '100vh' }}>
          ...
          {posts.length > 0 && !searchQuery && (
            <div className="post-section">
              <h2>Bài viết về xây dựng phần mềm bán điện thoại</h2>
                ...
                {posts.map((post) => (
                  <Link to={`/posts/${post.id}`} key={post.id} className="post-item">
                    <img
                      ...
                      onError={(e) => (e.target.src = 'https://tse1.mm.bing.net/th?id=OIP.T4S8ZRzkA6PcnOrzhkviGgHaEo&pid=Api&P=0&h=180')}
                    />

                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mx-auto nav-links">
                            <Nav.Link href="/user">Về ALONE PHONE</Nav.Link>
                            <Nav.Link onClick={() => handleRestrictedClick('/user/brands')}>
                                Thương hiệu
                            </Nav.Link>
                            <Nav.Link href="/user/categories/1">MAN PHONE</Nav.Link>
                            <Nav.Link href="/user/categories/2">GIRL PHONE</Nav.Link>
                            <Nav.Link href="/user/categories/3">COUPLE</Nav.Link>
